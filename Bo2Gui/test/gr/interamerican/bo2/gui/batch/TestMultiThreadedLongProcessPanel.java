...
public class TestMultiThreadedLongProcessPanel {
	...
	public static MultiThreadedLongProcess mockProcess(int countOfSubProcesses) {
		...
		Mockito.doReturn(MultithreadLongProcessExecutionStatus.START).when(process).getExecutionStatus();
	...
	public void testConstructor_withMockProcess() {
		...
		Assert.assertNotNull(panel.batchProcessExecutionStatusPanel);
	...
	public void testRefresh() {
		...
		Mockito.doReturn(MultithreadLongProcessExecutionStatus.START).when(model).getExecutionStatus();
