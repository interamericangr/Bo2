...
/**
 * Unit test for {@link TranslatableBoPropertyDescriptorWrapper}
 */
public class TestTranslatableBoPropertyDescriptorWrapper {
	...
	public void Init(){
		...
		wrapper = new TranslatableBoPropertyDescriptorWrapper<Integer,String,Long>(descriptor,resourceId,this.getClass().getName());
	}
