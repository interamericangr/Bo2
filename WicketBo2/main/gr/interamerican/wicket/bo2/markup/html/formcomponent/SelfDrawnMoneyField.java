...
/**
 * A self drawn form component that binds to a {@link Money} instance. This
 * works by adding to itself a {@link SelfDrawnBigDecimalTextField} that binds
 * the <code>amount</code> BigDecimal property of {@link Money}. <br>
 * The {@link MoneyBoPropertyDescriptor} meta-data are applied to the nested
 * text field.
 */
public class SelfDrawnMoneyField extends FormComponentPanel<Money> {
	 ...
	 */
	private SelfDrawnBigDecimalTextField createAmountField(String id, MoneyBoPropertyDescriptor descriptor,
			IModel<Money> model) {
	...
	public void convertInput() {
		/*
		 * If the amountField is disabled, do not take it into consideration at
		 * all.
		 */
	...
	/**
	 * Creates a {@link BigDecimalBoPropertyDescriptor} for the property
	 * <code>amount</code> of {@link Money} given the
	 ...
	 */
	BigDecimalBoPropertyDescriptor createAmountDescriptor(MoneyBoPropertyDescriptor descriptor) {
		...
		String defaultValue = descriptor.isHasDefault() ? String.valueOf(descriptor.getDefaultValue().getAmount())
				: null;
