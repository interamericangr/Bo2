 ...
 * 
 * @deprecated Use the Actions directly for those that are not deprecated
 */
@Deprecated
public class ActionFactory {
	 ...
	 */
	public static <K extends Serializable & Comparable<? super K>, P extends PersistentObject<K>, Q extends Question<K> & PoDependent<P>> CrudAction<K, P, Q> crudAction(
			BeanPanelDef<P> definition, Class<P> poClass, Class<Q> questionClass, CrudPerformer performer) {
	 ...
	 */
	public static <C extends Serializable, B extends Serializable, Q extends EntitiesQuery<B> & CriteriaDependent<C>> QueryAction<C, B, Q> queryAction(
			SearchFlowPanelDef<C, B> definition, Class<Q> queryClass) {
		return new QueryAction<C, B, Q>(definition, queryClass);
	}

	/**
	 * Creates a {@link AddElementToCollectionL} that will add a new item to the
	 * appropriate set of an owner object.
	 * 
	 * This action is intended to be used by a CrudPickerPanel that modifies an
	 * object's Set. In the case that an object has a property that is of type
	 * Set&lt;B&gt;, and the model list of the CrudPickerPanel is created by the
	 * elements of the Set, then this CallBack action can be used in order to
	 * add the new element in the Set. This action will synchronize the
	 * CrudPickerPanel's list with the object's set. The new Object will be
	 * added to the document with the method
	 ...
	 */
	public static <B extends Serializable> AddElementToCollectionL<B> addNextLAction(CrudPickerPanelDef<B> definition,
			Object owner, String collectionName, String indexPropertyName) {
	...
	/**
	 * Creates a {@link AddElementToCollectionI} that will add a new item to the
	 * appropriate set of an owner object.
	 * 
	 * This action is intended to be used by a CrudPickerPanel that modifies an
	 * object's Set. In the case that an object has a property that is of type
	 ...
	 * @return Returns a CallBack action.
	 */
	public static <B extends Serializable> AddElementToCollectionI<B> addNextIAction(CrudPickerPanelDef<B> definition,
			Object owner, String collectionName, String indexPropertyName) {
		Collection<B> col = getCollection(owner, collectionName);
		B b = definition.getBeanModel().getObject();
	...
	/**
	 * Creates a {@link RemoveElementFromCollection} that will add a new item to
	 * the appropriate set of an owner object.
	 * 
	 * This action is intended to be used by a CrudPickerPanel that modifies an
	 * object's Set. In the case that an object has a property that is of type
	 * Set&lt;B&gt;, and the model list of the CrudPickerPanel is created by the
	 ...
	 * @return Returns a CallBack action.
	 */
	public static <B extends Serializable> RemoveElementFromCollection<B> removeAction(CrudPickerPanelDef<B> definition,
			Object owner, String collectionName) {
	...
	static <B> Collection<B> getCollection(Object owner, String collectionName) {
		...
		Collection<B> collection = (Collection<B>) c;
		return collection;
	}
