...
/**
 * Action that will update a {@link PersistentObject} with the use of it's
 * {@link PersistenceWorker}.
 * 
 * @param <P>
 *            Type of {@link PersistentObject}
 */
public class UpdateAction<P extends PersistentObject<?>>
implements ProcessAction<P> {
	 ...
	 */
	public UpdateAction(Class<P> poClass) {
