...
/**
 * Unit test for {@link CalculatePercentageOfMoney}.
 */
public class TestCalculatePercentageOfMoney {
	...
	public void testExecute_Bd2Bd() {
		...
		nb.setBdAmount1(bd1);
		CalculatePercentageOfMoney<MoneyBean> calc = new CalculatePercentageOfMoney<MoneyBean>("bdAmount1", "bdAmount2",
				MoneyBean.class, new BigDecimal("0.23"), EURO, true);
		calc.execute(nb);
	...
	public void testExecute_Money2Money() {
		...
		CalculatePercentageOfMoney<MoneyBean> calc = new CalculatePercentageOfMoney<MoneyBean>("moneyAmount1",
				"moneyAmount2", MoneyBean.class, new BigDecimal("0.23"), EURO, true);
		calc.execute(nb);
	...
	public void testExecute_Bd2Money() {
		...
		BigDecimal bd1 = new BigDecimal("13.145");
		nb.setBdAmount1(bd1);
		CalculatePercentageOfMoney<MoneyBean> calc = new CalculatePercentageOfMoney<MoneyBean>("bdAmount1",
				"moneyAmount2", MoneyBean.class, new BigDecimal("0.23"), EURO, true);
		calc.execute(nb);
		Money expected = new MoneyImpl(new BigDecimal("3.02"), EURO);
		Assert.assertEquals(expected, nb.getMoneyAmount2());
	...
	public void testExecute_Money2Bd() {
		...
		nb.setMoneyAmount1(money1);
		CalculatePercentageOfMoney<MoneyBean> calc = new CalculatePercentageOfMoney<MoneyBean>("moneyAmount1",
				"bdAmount2", MoneyBean.class, new BigDecimal("0.23"), EURO, true);
		calc.execute(nb);
		BigDecimal expected = new BigDecimal("3.02");
		Assert.assertEquals(expected, nb.getBdAmount2());
