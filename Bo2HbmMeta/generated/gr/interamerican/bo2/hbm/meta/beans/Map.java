...
@XmlType(name = "", propOrder = {
    ...
    "comment",
    "key",
    "mapKeyOrCompositeMapKeyOrMapKeyManyToManyOrIndexOrCompositeIndexOrIndexManyToManyOrIndexManyToAny",
...
public class Map {
    ...
    protected Key key;
    @XmlElements({
        @XmlElement(name = "map-key", required = true, type = MapKey.class),
        @XmlElement(name = "composite-map-key", required = true, type = CompositeMapKey.class),
        @XmlElement(name = "map-key-many-to-many", required = true, type = MapKeyManyToMany.class),
        @XmlElement(name = "index", required = true, type = Index.class),
        @XmlElement(name = "composite-index", required = true, type = CompositeIndex.class),
        @XmlElement(name = "index-many-to-many", required = true, type = IndexManyToMany.class),
        @XmlElement(name = "index-many-to-any", required = true, type = IndexManyToAny.class)
    })
    protected List<Object> mapKeyOrCompositeMapKeyOrMapKeyManyToManyOrIndexOrCompositeIndexOrIndexManyToManyOrIndexManyToAny;
    @XmlElements({
     ...
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the mapKeyOrCompositeMapKeyOrMapKeyManyToManyOrIndexOrCompositeIndexOrIndexManyToManyOrIndexManyToAny property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     ...
     * 
     */
    public List<Object> getMapKeyOrCompositeMapKeyOrMapKeyManyToManyOrIndexOrCompositeIndexOrIndexManyToManyOrIndexManyToAny() {
        if (mapKeyOrCompositeMapKeyOrMapKeyManyToManyOrIndexOrCompositeIndexOrIndexManyToManyOrIndexManyToAny == null) {
            mapKeyOrCompositeMapKeyOrMapKeyManyToManyOrIndexOrCompositeIndexOrIndexManyToManyOrIndexManyToAny = new ArrayList<Object>();
        }
        return this.mapKeyOrCompositeMapKeyOrMapKeyManyToManyOrIndexOrCompositeIndexOrIndexManyToManyOrIndexManyToAny;
    }
