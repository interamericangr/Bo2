...
public class List {
    ...
    protected java.util.List<Object> indexOrListIndex;
    @XmlElements({
    ...
    protected java.util.List<Object> elementOrOneToManyOrManyToManyOrCompositeElementOrManyToAny;
     ...
     * 
     */
    public java.util.List<Object> getIndexOrListIndex() {
     ...
     * 
     */
    public java.util.List<Object> getElementOrOneToManyOrManyToManyOrCompositeElementOrManyToAny() {
