...
@XmlType(name = "", propOrder = {
    ...
    "collectionId",
    "key",
    "elementOrManyToManyOrCompositeElementOrManyToAny",
    "loader",
    "sqlInsert",
    "sqlUpdate",
    "sqlDelete",
...
public class Idbag {
    ...
    protected List<Object> elementOrManyToManyOrCompositeElementOrManyToAny;
     ...
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the elementOrManyToManyOrCompositeElementOrManyToAny property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     ...
     * 
     */
    public List<Object> getElementOrManyToManyOrCompositeElementOrManyToAny() {
        if (elementOrManyToManyOrCompositeElementOrManyToAny == null) {
            elementOrManyToManyOrCompositeElementOrManyToAny = new ArrayList<Object>();
        }
        return this.elementOrManyToManyOrCompositeElementOrManyToAny;
    }
