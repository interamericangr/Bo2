...
public class ArrayUtils {
	 ...
	 * copy of the input array with the specified capacity is returned. The
	 ...
	 * 
	 * If the array has exactly the specified capacity, then the same array is
	 * returned. If the array has less or more size than the specified capacity,
	 * then a copy of the input array with the specified capacity is returned.
	 ...
	 *            Array checked.
	 * 
	 * @return Returns the index of the first null element of the array. If the
	 *         array does not contain any null element, then returns null.
	 */
	...
	/**
	 * Checks to make sure that the array contains a not null element in a
	 * specified index.
	 * 
	 * @param array
	 *            array checked
	 ...
	 *            Index searched.
	 * 
	 * @return Returns true if the array contains a not null element in the
	 *         specified position. If the specified index contains a null, or if
	 *         the array has less elements than the index, then returns false.
	 */
	...
	private static <T, U> T[] copyOf(U[] original, int newLength, Class<? extends T[]> newType) {
		T[] copy = newArray(newLength, newType);
		System.arraycopy(original, 0, copy, 0, Math.min(original.length, newLength));
		return copy;
	}

	/**
	 * Creates a new array that aims to be a partial or complete copy of the
	 * specified original.
	 * 
	 * <br>
	 * This method is a copy from the class java.util.Arrays from JDK 1.6.
	 ...
	 *             if <tt>original</tt> is null
	 */
	private static <T, U> T[] newArray(int newLength, Class<? extends T[]> newType) {
		@SuppressWarnings("unchecked")
	...
	/**
	 * Transforms an array of objects to a list of object arrays, with each
	 * array containing one element of the input array.
	 * 
	 ...
	 * @param array
	 *            Array from which the nulls are removed.
	 * @return Returns an array with the same elements as the input array, but
	 *         without nulls. If the initial array contained any null then the
	 *         new array is packed, eliminating nulls.
	 */
	...
	/**
	 * Gets an element from the given array that corresponds to the given index,
	 * taking into account bad input. The result is the equivalent of
	 * array[index] if the index is in bounds and the array is not null.
	 *
	 * @param <T>
	 *            elements type.
	 * 
	 ...
	 * @param array2
	 *            the array 2
	 * @return Returns true if the two arrays have the same elements one by one.
	 */
	...
	public static <T> T[] right(T[] original, int start) {
		...
		T[] copy = (T[]) newArray(newLength, original.getClass());
