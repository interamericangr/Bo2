...
public enum IndexPropertyType {
	 ...
	 *
	 * @param compatibleTypes the compatible types
	 */
	 ...
	 * @param collection            Collection in which the next element is being added.
	 * @param nextElement            Next element that will be added in the collection.
	 * @param indexPropertyName            Name of the property that defines the index.
	 */	
