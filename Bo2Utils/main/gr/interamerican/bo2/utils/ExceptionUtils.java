...
public class ExceptionUtils {
	 ...
	 *            Type
	 * 
	 * @return Returns true if the initial cause of the thrown was of type
	 *         causeType.
	 */
	public static boolean isCausedBy(Throwable thrown, Class<? extends Throwable> causeType) {
	...
	/**
	 * Gets the cause in the stack trace chain that belongs to a specified
	 * Throwable type.
	 *
	 * @param <T>
	 *            Type of Throwable.
	 ...
	 * @param causeType
	 *            Type of Throwable.
	 * @return Returns The throwable in the chain of causes of this Exception
	 *         that belongs to the specified type. If there is no cause that
	 *         belongs to the specified type, then returns null.
	 */
	@SuppressWarnings("unchecked")
	public static <T extends Throwable> T causeInTheChain(Throwable thrown, Class<T> causeType) {
		if (causeType.isAssignableFrom(thrown.getClass())) {
			return (T) thrown;
		}
		Throwable cause = thrown.getCause();
	 ...
	 * 
	 * If t is a {@link RuntimeException} the method will return it. If it an
	 * instance of any type of checked {@link Exception} the method will throw a
	 * RuntimeException with t as its cause.
	 * 
	 * @param t
	 *            Throwable that has to be transformed to an unchecked
	 *            Exception.
	 * 
	 ...
	 * 
	 * @param t
	 *            Throwable that has to be transformed.
	 * 
