 ...
 *            the generic type
 */
public class PropertyIsNotNull<T> extends ConditionOnTransformation<T, Object> {
	 ...
	 *            Getter
	 */
	public PropertyIsNotNull(Function<T, ?> getter) {
		super(getter::apply, new IsNotNull<Object>());
	}
}