...
/**
 * The Class TestPropertyBasedComparator.
 */
@Deprecated
public class TestPropertyBasedComparator {
	...
	public void testCompare_Integers() {
		...
		PropertyBasedComparator<SampleBean> intComparator = new PropertyBasedComparator<SampleBean>(SampleBean.class,
				"field2"); //$NON-NLS-1$
		SampleBean bean1 = new SampleBean();
		bean1.setField2(2);
		SampleBean bean2 = new SampleBean();
		bean2.setField2(3);
		Comparator<SampleBean> other = Comparator.comparing(SampleBean::getField2);
		assertEquals(-1, intComparator.compare(bean1, bean2));
		assertEquals(-1, other.compare(bean1, bean2));
	}
	...
	public void testCompare_Strings() {
		...
		PropertyBasedComparator<SampleBean> stringComparator = new PropertyBasedComparator<SampleBean>(SampleBean.class,
				"field1"); //$NON-NLS-1$
		SampleBean bean1 = new SampleBean();
		bean1.setField1("b"); //$NON-NLS-1$
		SampleBean bean2 = new SampleBean();
		bean2.setField1("a"); //$NON-NLS-1$
		Comparator<SampleBean> other = Comparator.comparing(SampleBean::getField1);
	...
	public void testConstructorAndCompare_WithCompositeProperty() {
		...
		PropertyBasedComparator<BeanWithNestedBean> cmpField1 = new PropertyBasedComparator<BeanWithNestedBean>(
				BeanWithNestedBean.class, "nested.field1");
		PropertyBasedComparator<BeanWithNestedBean> cmpField2 = new PropertyBasedComparator<BeanWithNestedBean>(
				BeanWithNestedBean.class, "nested.field2");
		Comparator<BeanWithNestedBean> other1 = Comparator.comparing(
				FunctionalUtils.nullSafeSynthesize(BeanWithNestedBean::getNested, BeanWith2Fields::getField1));
		Comparator<BeanWithNestedBean> other2 = Comparator.comparing(
		...
		assertEquals(-1, other1.compare(bean1, bean2));
		assertEquals(1, other2.compare(bean1, bean2));
	}
