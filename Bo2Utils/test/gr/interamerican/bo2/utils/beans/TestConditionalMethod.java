...
public class TestConditionalMethod {
	...
	private ConditionalMethod<BeanWith2Fields, TestConditionalMethod> getCM(boolean onlyFirst) {

		ConditionalMethod<BeanWith2Fields, TestConditionalMethod> cm = new ConditionalMethod<BeanWith2Fields, TestConditionalMethod>(
				onlyFirst, BeanWith2Fields.class, TestConditionalMethod.class);

		Condition<BeanWith2Fields> field1isOnE = new PropertyEqualsTo<>(BeanWith2Fields::getField1, ONE);
		cm.register(field1isOnE, "setField1IsOneTrue");

		Condition<BeanWith2Fields> field2isZero = new PropertyEqualsTo<>(BeanWith2Fields::getField2, 0);
		cm.register(field2isZero, "setField2IsZeroTrue");

		Condition<BeanWith2Fields> field1isNotNull = new PropertyEqualsTo<>(BeanWith2Fields::getField2, 0);
	...
	public void testConstructor() {
		ConditionalMethod<String, Date> cm = new ConditionalMethod<String, Date>(true, String.class, Date.class);
	...
	public void testExecute_onlyFirst() {
		ConditionalMethod<BeanWith2Fields, TestConditionalMethod> cm = getCM(true);
	...
	public void testExecute_all() {
		ConditionalMethod<BeanWith2Fields, TestConditionalMethod> cm = getCM(false);
		BeanWith2Fields bean = new BeanWith2Fields();
		bean.setField1(null);
		bean.setField2(0);
		cm.execute(bean, this);
