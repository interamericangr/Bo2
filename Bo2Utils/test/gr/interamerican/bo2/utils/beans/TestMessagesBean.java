...
public class TestMessagesBean {
	...
	/**
	 * Path to an XML resource bundle file.
	 */
	private static final String XML_PATH = "gr.interamerican.bo2.utils.beans.MessagesBeanXml"; //$NON-NLS-1$
	...
	public void testGetString_xml() {
		MessagesBean bean = new MessagesBean(XML_PATH);
		String msg = bean.getString(MSG1);
		Assert.assertNotNull(msg);		
	}
	 ...
	 */
	@Test
	public void testGetString_missingKey_xml() {
		MessagesBean bean = new MessagesBean(XML_PATH);
		String key = "nokey"; //$NON-NLS-1$
		String expected = "!"+key+"!";  //$NON-NLS-1$//$NON-NLS-2$
		String msg = bean.getString(key);
