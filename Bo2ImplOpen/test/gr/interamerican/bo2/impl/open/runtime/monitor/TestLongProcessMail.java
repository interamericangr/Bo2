...
public class TestLongProcessMail {
	...
	public void testBeModified() {
		...
		String toList = "me@there.com, him@there.com";
		long interval = 1000L;
		p.setProperty(MonitoringConstants.MONITOR_MESSAGE_FROM, from);
		p.setProperty(MonitoringConstants.MONITOR_MESSAGE_RECIPIENTS, toList);
		p.setProperty(MonitoringConstants.MONITOR_MESSAGE_INTERVAL, Long.toString(interval));
		mail.beModified(p);
