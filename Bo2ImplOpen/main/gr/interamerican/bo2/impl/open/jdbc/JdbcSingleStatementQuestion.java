 ...
 * order of the parameters. The first alternative is to use the functionality of
 ...
 * Do note that :parm.subtype is also supported in the sql statement.
 * 
 * @param <A>
 *            Type of answer.
 */
public abstract class JdbcSingleStatementQuestion<A>
extends JdbcQuestion<A> {
