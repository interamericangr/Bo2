...
/**
 * A {@link DoubleConverter} that is customized to display results as
 * percentages.
 */
public class PercentageDoubleConverter extends DoubleConverter {
	 ...
	 *            Decimal digits to display
	 */
	public PercentageDoubleConverter(Integer decimals) {
