...
implements SpanFragment {
	...
	void analyze(String string) {
		...
		fragments.add(phrase);
		int indexOfNonSpaceAfterSpaceSeq = positionOfFirstNonSpace(string, indexOfFirstSpaceSeq);
	...
	/**
	 * Finds the position of the first non space character in the specified
	 ...
	 *            character in string.
	 * 
	 * @return Returns the place of first occurrence of a non space character
